...
contract HUSRUM is ERC721, ERC721URIStorage, Ownable {
    ...
    // ************************************************ //
    /* I change the functions after and before from the ERC721 contract.
       I change them to implement the principle of SBT tokens - non-transferability.
       You can transfer only 1 time and then only from the token owner to the wallet.
    */
    function _beforeTokenTransfer(
        address from,
        address to,
